...
class CMS:
    ...
    def create_post(self, title, content, excerpt, org, author,
        ...
        log.info("[CMS] Created blog post #%s: %s (%s/%s)", extra={"post_id": post_id, "title": title, "org": org})
        return result
    ...
    def update_post(self, post_id, **kwargs):
        ...
        log.info("[CMS] Updated blog post #%s", extra={"post_id": post_id})
        return result
    ...
    def publish_post(self, post_id):
        ...
        log.info("[CMS] Published blog post #%s", extra={"post_id": post_id})
        return result
    ...
    def schedule_post(self, post_id, scheduled_for):
        ...
        log.info("[CMS] Scheduled blog post #%s for %s", extra={"post_id": post_id, "scheduled_for": scheduled_for})
        return result
    ...
    def create_newsletter(self, title, org, html_content, status="draft",
        ...
        log.info("[CMS] Created newsletter #%s: %s (%s)", extra={"nl_id": nl_id, "title": title, "org": org})
        return result
    ...
    def create_social_post(self, content, org, platform, status="draft",
        ...
        log.info("[CMS] Created social post #%s for %s (%s)", extra={"sp_id": sp_id, "platform": platform, "org": org})
        return result
    ...
    def create_case_study(self, title, client, description, tech_stack,
        ...
        log.info("[CMS] Created case study #%s: %s (%s)", extra={"cs_id": cs_id, "title": title, "org": org})
        return result
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Cms Ops")
