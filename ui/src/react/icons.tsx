...
// Lucide-style SVG icons converted from Lit templates to React components
...
function Svg({ children, ...props }: SVGProps<SVGSVGElement>) {
  return <svg {...svgBase} {...props}>{children}</svg>;
}

export const Icons = {
  messageSquare: (p?: SVGProps<SVGSVGElement>) => (
  ...
  scrollText: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}>
  ...
  send: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}><path d="m22 2-7 20-4-9-9-4Z" /><path d="m22 2-11 11" /></Svg>
  ),
  ...
  userCircle: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}>
  ...
  stop: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}><rect width="14" height="14" x="5" y="5" rx="1" /></Svg>
  ),
  ...
  refreshCw: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}>
  ...
  puzzle: (p?: SVGProps<SVGSVGElement>) => (
    <Svg {...p}>
...
export function Icon({ name, className }: { name: IconName; className?: string }) {
  ...
  return <span className={className ?? "icon"} aria-hidden="true">{IconFn()}</span>;
}
