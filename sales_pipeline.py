...
from exceptions import AiElevateError  # TODO: Use specific exception types, PlaneError
...
def create_invoice(
    ...
    try:
        ...
        except (AiElevateError, Exception) as e2:
            return {
                "invoice_id": None,
                "payment_url": None,
                "amount_eur": deposit_eur,
...
def kickoff_project(
    ...
    except (PlaneError, Exception) as e:
