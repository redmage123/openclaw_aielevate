...
from exceptions import AiElevateError  # TODO: Use specific exception types, AgentError, KnowledgeGraphError

sys.path.insert(0, "/home/aielevate")

log = get_logger("org-builder")
...
async def setup_knowledge_graph(input: OrgBuildInput) -> bool:
    ...
    try:
        ...
        return True
    except (KnowledgeGraphError, Exception) as e:
