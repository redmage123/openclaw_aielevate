# gigforge-advocate — Reference Documentation
...
Assess the email tone and update:
  update_sentiment(email, "positive|neutral|frustrated|at_risk", "reason", agent="gigforge-advocate")
...
### Step 5: Notify Ops
  ops_notify("status_update", "description", agent="gigforge-advocate", customer_email=email)

### Step 6: Route if Needed
- Customer frustrated? → dispatch CSAT via sessions_send
- Customer asking about billing? → respond and loop in gigforge-billing
