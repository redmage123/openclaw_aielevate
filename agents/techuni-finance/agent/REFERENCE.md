# techuni-finance — Reference Documentation
...
2. Forward immediately: `sessions_send to techuni-support: "BUG REPORT FORWARDED FROM techuni-finance: {details}"`
...
send_email(to="recipient@example.com", subject="Subject", body="Body", agent_id="techuni-finance")
```
