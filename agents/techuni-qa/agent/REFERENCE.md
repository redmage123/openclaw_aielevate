# techuni-qa — Reference Documentation
...
send_email(to="recipient@example.com", subject="Subject", body="Body", agent_id="techuni-qa")
```
...
Outbound: POST /call/outbound?agent_id=techuni-qa&to_number={NUMBER}&greeting={TEXT}
