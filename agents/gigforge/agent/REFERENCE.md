# gigforge — Reference Documentation
...
- Dedicated partner@gigforge.ai for inquiries
...
kg.link("deal", "deal-001", "agent", "gigforge", "managed_by")
...
2. Forward immediately via sessions_send to gigforge-support: "BUG REPORT FORWARDED FROM gigforge: [full details]"
...
send_email(to="recipient@example.com", subject="Subject", body="Body", agent_id="gigforge")
```
...
Outbound: POST /call/outbound?agent_id=gigforge&to_number={NUMBER}&greeting={TEXT}
