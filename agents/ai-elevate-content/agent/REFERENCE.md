# ai-elevate-content — Reference Documentation
...
send_email(to="recipient@example.com", subject="Subject", body="Body", agent_id="ai-elevate-content")
```
