...
def wrapped_agent_call(agent_id: str, message: str, sender_email: str = "",
    ...
    # 1. Pull customer context and inject into message
    context_text = ""
    try:
    ...
    if context_text:
        enhanced_message += context_text
    if directives_text:
        enhanced_message += directives_text
    ...
    # 3. Check for acceptance → dispatch advocate handoff
    ...
    # 4. Check for frustration → dispatch CSAT
